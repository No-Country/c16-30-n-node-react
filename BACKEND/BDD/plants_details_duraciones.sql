...
CREATE TABLE `duraciones` (
  `id_duraciones` int NOT NULL AUTO_INCREMENT,
  `duracion` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id_duraciones`),
  UNIQUE KEY `id_duraciones_UNIQUE` (`id_duraciones`),
  UNIQUE KEY `duracion_UNIQUE` (`duracion`)
...
INSERT INTO `duraciones` VALUES (1,'Anual'),(2,'Bienal'),(3,'Perenne');
